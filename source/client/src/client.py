...
staffs = [[1, 'Nguyen Quang Binh', '077xxxxxxx', '2012xxxx@student.hcmus.edu.vn', 'source/server/assets/images/avt.png', 'source/server/assets/images/avt.png'],
          [2, 'Nguyen Trong Hieu', '078xxxxxxx', '2012xxxx@student.hcmus.edu.vn',
              'source/server/assets/images/avt.png', 'source/server/assets/images/avt.png'],
...
class Client:
    ...
    def show_all_staffs(self):
        ...
        self.all_staffs = ttk.Treeview(
            self.root.all_staffs_frame, show='headings')
    ...
    def show_detail_a_staff(self, event):
        ...
        self.root.staff_detail_frame.avatar = ImageTk.PhotoImage(
            Image.open(staffs[iid][4]).resize((100, 100), Image.ANTIALIAS))
